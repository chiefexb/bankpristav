...
begin
  ...
  dm.ibqry4.Open;
  dm.ibqry4.First;
  //Счет 42301810060310574746 8585/19 Остаток 0 RUR
  text:='';
  repeat
    text:=text+'Счет '+Dm.ibqry4.fieldbyname('ACC').AsString+' ' ;
    text:=text+'Остаток '+ Dm.ibqry4.fieldbyname('Summa').AsString+' ' ;
